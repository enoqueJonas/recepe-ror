...
Simple recipe app made in Rails that will show the list of recipes and empower users to create their own by adding new recipes and foods. It will also display a list of items and total price.
...
cd my-folder
git clone https://github.com/enoqueJonas/recepe-ror
